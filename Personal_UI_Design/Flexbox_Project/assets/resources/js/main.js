$(document).ready(function(){
    ...
    $("ul.menus li.menu-item").click(function(){
...
/////////////////////////NAVBAR MENU ACTIVE JS END
        ...
        var homeHover = $('.navbar .about');
        homeHover.on({
            mouseenter:function(){
            $('.navbar .menus .about-dropdown').addClass('about-active');
            //Plus icon Change on Hover
                 $('.navbar a.about').addClass("active");
            }
            });
            var homeHover = $('.navbar .about-menu');
            homeHover.on({
            mouseleave:function(){
            $('.navbar .menus .about-dropdown').removeClass('about-active');
            //Plus icon Change on Hover
            $('.navbar a.about').removeClass("active");
            }
            });
        ...
        facilitiesHover.on({
            ...
            // hrm dropdown menus Start
        var facilitiesHover = $('.navbar .hrm');
        facilitiesHover.on({
            mouseenter:function(){
            $('.navbar .menus .hrm-dropdown').addClass('hrm-active');
              //Plus icon Change on Hover
              $('.navbar a.hrm').addClass("active");
            }
            });
            var facilitiesHover = $('.navbar .hrm-menu');
            facilitiesHover.on({
            mouseleave:function(){
            $('.navbar .menus .hrm-dropdown').removeClass('hrm-active');
             //Plus icon Change on Hover
             $('.navbar a.hrm').removeClass("active");
            }
            });
            // Facilities Dropdown Menus End

            // form dropdown menus Start
        var facilitiesHover = $('.navbar .form');
        facilitiesHover.on({
            mouseenter:function(){
            $('.navbar .menus .form-dropdown').addClass('form-active');
              //Plus icon Change on Hover
              $('.navbar a.form').addClass("active");
            }
            });
            var facilitiesHover = $('.navbar .form-menu');
            facilitiesHover.on({
            mouseleave:function(){
            $('.navbar .menus .form-dropdown').removeClass('form-active');
             //Plus icon Change on Hover
             $('.navbar a.form').removeClass("active");
            }
            });
            // form Dropdown Menus End

            // gallery dropdown menus Start
        var facilitiesHover = $('.navbar .gallery');
        facilitiesHover.on({
            mouseenter:function(){
            $('.navbar .menus .gallery-dropdown').addClass('gallery-active');
              //Plus icon Change on Hover
              $('.navbar a.gallery').addClass("active");
            }
            });
            var facilitiesHover = $('.navbar .gallery-menu');
            facilitiesHover.on({
            mouseleave:function(){
            $('.navbar .menus .gallery-dropdown').removeClass('gallery-active');
             //Plus icon Change on Hover
             $('.navbar a.gallery').removeClass("active");
            }
            });
            // gallery Dropdown Menus End

            // social dropdown menus Start
        var facilitiesHover = $('.navbar .social');
        facilitiesHover.on({
            mouseenter:function(){
            $('.navbar .menus .social-dropdown').addClass('social-active');
              //Plus icon Change on Hover
              $('.navbar a.social').addClass("active");
            }
            });
            var facilitiesHover = $('.navbar .social-menu');
            facilitiesHover.on({
            mouseleave:function(){
            $('.navbar .menus .social-dropdown').removeClass('social-active');
             //Plus icon Change on Hover
             $('.navbar a.social').removeClass("active");
            }
            });
            // social Dropdown Menus End
