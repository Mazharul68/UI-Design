(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($.browser.mobile) {
            ...
            /* If it is mobile disable datepicker */
        ...
        if ($('#add_review').length != 0) {
            ...
            add_review_button.click(function () {
                $('#add_review_wrapper').css({'display': 'block'});
            });
            $('#book_trigger').click(function (event) {
    ...
    /*Shows a excerpt in the block of the lastest posts on the index page */
